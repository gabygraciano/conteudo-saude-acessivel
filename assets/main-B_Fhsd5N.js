import{i as d,f as l}from"./font-controls-D4c1pFvm.js";document.addEventListener("DOMContentLoaded",async()=>{d(),await u(),_()});let a=[],c="todos";async function u(){document.getElementById("content-grid");const t=document.getElementById("loading-state");try{a=await l(),t.style.display="none",i(a)}catch{t.innerHTML=`
